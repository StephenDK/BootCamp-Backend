...
exports.login = asyncHandler(async (req, res, next) => {
    ...
    // to match the password we will create a method on the user model
    // head over to model/User
...
// Custom function to get token from model and create cookie and send response
